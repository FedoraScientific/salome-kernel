...
MACRO(SALOME_INSTALL_SCRIPTS file_list path)
  ...
  FOREACH(file ${file_list})
    ...
    IF(ext STREQUAL .py)
      INSTALL(CODE "MESSAGE(STATUS \"py compiling \$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${path}/${file_name}\")")
      INSTALL(CODE "SET(CMD \"import py_compile ; py_compile.compile('\$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${path}/${file_name}')\")")
    ...
    IF(("${mode}" STREQUAL "NO_MODULE") OR ("${mode}" STREQUAL "CONFIG"))
      ...
      IF(${englobPkg}_FIND_COMPONENTS)
        FIND_PACKAGE(${stdPkg} ${${englobPkg}_FIND_VERSION} ${_tmp_exact} 
              ...
              PATH_SUFFIXES "share/salome/adm/cmake_files"
